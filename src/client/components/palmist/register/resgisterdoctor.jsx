  ...
  const handleRegistration = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:4007/api/doctorpersnoldetails",
        alldata
      );
  ...
  return (
    <>
      ...
      <div className="container  d-flex justify-content-center align-items-center  ">
        <div
          className="card-resgister p-5 "
          style={{ width: "30rem", marginTop: "10rem", border: "none" }}
        >
          ...
          <form onSubmit={handleRegistration}>
            ...
            <div className="mb-4">
              <label
                ...
                className="form-label text-gray-600"
              >
                Specialization
              </label>
              <input
...
=======
            ...
            const response = await axios.post('3005/api/doctorpersnoldetails', alldata);
            ...
            <div className="container  d-flex justify-content-center align-items-center  ">
                <div className="card-resgister p-5 " style={{ width: "30rem", marginTop: "10rem", border: "none" }}>
                    ...
                    <form onSubmit={handleRegistration}>
                        ...
                        {/* <label htmlFor="date" className="block text-gray-800 text-sm font-bold mb-2 items-center justify-center">
>>>>>>> 76b46ee3f7c64162d444da418951c754500355a3
                            Once
                        </label> */}
