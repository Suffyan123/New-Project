                        ...
                        <div className="chat-cont-left">
                          ...
                          <div className="chat-users-list">
                            <div className="chat-scroll">
                              ...
                              <Link
                                to="#"
                                className="media d-flex read-chat active"
                              >
                                <div className="media-img-wrap flex-shrink-0">
                              ...
                              <Link to="#" className="media d-flex">
                                ...
                                <div className="media-body flex-grow-1">
                                  <div>
                                    ...
                                    <div className="user-last-chat">
                                      Give me a full explanation about our
                                      project
                                    </div>
                                  </div>
                                  <div>
                              ...
                              <Link to="#" className="media d-flex read-chat">
                                ...
                                <div className="media-body flex-grow-1">
                                  <div>
                                    ...
                                    <div className="user-last-chat">
                                      This has allowed me to showcase not only
                                      my technical skills
                                    </div>
                                  </div>
                                  <div>
                              ...
                              <Link to="#" className="media d-flex read-chat">
                                ...
                                <div className="media-body flex-grow-1">
                                  <div>
                                    ...
                                    <div className="user-last-chat">
                                      Do you have any collections? If so, what
                                      of?
                                    </div>
                                  </div>
                                  <div>
